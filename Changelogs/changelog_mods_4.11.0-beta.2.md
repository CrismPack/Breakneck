...
- **Entity Texture Features -**: Changed from `entity_texture_features_1.21.11-fabric-7.0.8.jar` to `entity_texture_features_1.21.11-fabric-7.0.9.jar`
- **Fabric API**: Changed from `fabric-api-0.141.1+1.21.11.jar` to `fabric-api-0.141.3+1.21.11.jar`
